...
const en = {
  ...
  "landing.eyebrow": "Model agency software",
  "landing.headline": "Your roster, calendar, and bookings — finally in one place.",
  "landing.sub":
    "LuxLane is the operating system boutique agencies use instead of spreadsheets, group chats, and scattered folders. Board, book, invoice, and share packages with clients.",
  "landing.footer.tagline": "Built for bookers who move fast.",
